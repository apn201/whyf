...
CATALOG = [
    ...
    ("rto", "Recovery Time Objective", "RC", "control"),
    ("isms", "Information security management system", "GV", "attestation"),
    ("soc2", "SOC 2 report", "GV", "attestation"),
    ("pci-dss", "PCI DSS scope", "GV", "attestation"),
    ("hipaa", "HIPAA and business associate agreements", "GV", "attestation"),
    ("dora", "DORA and financial-sector customers", "GV", "attestation"),
    ("dpa", "Data processing agreement", "GV", "control"),
    ("subprocessors", "Subprocessors", "GV", "control"),
    ("data-transfers", "International data transfers", "GV", "control"),
    ("personal-data-breach", "Personal data breach notification", "RS", "control"),
    ("dsar", "Data subject requests", "GV", "control"),
    ("data-retention", "Retention and deletion", "PR", "control"),
    ("secure-disposal", "Secure disposal of data and kit", "PR", "control"),
    ("risk-acceptance", "Exceptions and risk acceptance", "GV", "control"),
    ("security-metrics", "Security objectives and metrics", "GV", "control"),
    ("shared-accounts", "Unique accounts, no sharing", "PR", "control"),
    ("least-privilege", "Least privilege and access review", "PR", "control"),
    ("attack-surface", "What is exposed to the internet", "ID", "control"),
    ("credential-monitoring", "Leaked credential monitoring", "DE", "control"),
    ("shadow-it", "Cloud and SaaS in use", "ID", "control"),

    ("ropa", "Record of processing activities", "GV", "control"),
    ("monitoring-privacy", "Monitoring staff lawfully", "GV", "control"),
    ("local-admin-rights", "Local administrator rights", "PR", "control"),
